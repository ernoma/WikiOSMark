L.Wheelmap = L.FeatureGroup.extend({
  ...
  getWheelmapNodeTypes: function() {
    ...
    var imgURL = this.options.iconPath + "/" + node.wheelchair + "/" + this.options.wheelmap_nodetypes[node.node_type.id - 1].icon;
