...
module.exports = function(o) {
    ...
    oauth.authComplete = function(token) {
        var oauth_token = ohauth.stringQs(token.split('?')[1]);
        this.get_access_token(oauth_token.oauth_token);
    ...
    oauth.get_access_token = function(oauth_token) {
      console.log("in get_access_token");
        ...
        console.log(url);
        console.log(params);
        ohauth.xhr('POST', url, params, null, {}, this.accessTokenDone);
        o.loading();
    }

    oauth.accessTokenDone = function(err, xhr) {
        console.log("in accessTokenDone");
        console.log("err: " + err);
        o.done();
        if (err) return o.authCallback(err);
        var access_token = ohauth.stringQs(xhr.response);
        token('oauth_token', access_token.oauth_token);
        token('oauth_token_secret', access_token.oauth_token_secret);
        o.authCallback(null, oauth);
    }
